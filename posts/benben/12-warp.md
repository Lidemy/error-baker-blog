...
既然如此，究竟 `Warp` 這個 terminal 是不是只是套一個 AI 而已的 terminal 呢？讓我們繼續看下去 ~ 想也知道當然不是！不然筆者就不會寫這篇文章了，你說是吧？
...
但其實不管有沒有推廣計劃，我本來就會分享好用的工具了，那讀者要不要裝，也是取決在個人，如何裝我也管不著，我就佛系推的的概念啦。
...
另外，私心覺得 Warp 官方的 Developer Advocate(這個不知道怎麼翻，倡導者？) Jess 很猛，口條很好、有時又帶點搞笑，完全顛覆，我的對這種技術教學的印象，也在她身上學到不少，想了解更多 Warp，推薦大家也可以看一下 Warp 的官方 demo。
...
光這些指令，已經可以減少不少使用滑鼠的時間了，再加上 `Raycast` 跟 `Vim`，根本不用滑鼠了吧（咦）一起加入鍵盤魔人吧！
